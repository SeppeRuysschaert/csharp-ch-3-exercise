...
static bool PlayerWantsAnotherGame()
{
    char c = '?';
    while (c != 'y' && c != 'n')
    {
...
static void DisplayHandsAndTotals(Hand dealerHand, Hand playerHand)
{
    Console.WriteLine();
    Console.WriteLine("================");
...
static string MapHand(IEnumerable<BlackJackCard> hand)
{
